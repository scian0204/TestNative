...
function App(): JSX.Element {
  ...
  const [answerWord, setAnswerWord] = useState(wordList[Math.floor(Math.random() * wordList.length)].toUpperCase())
  const reset = () => {
  ...
  const resetHandler = () => {
    reset()
    setAnswerWord(wordList[Math.floor(Math.random() * wordList.length)].toUpperCase())
    setLine(0)
    setWord("")
    setMsg("")
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button title='➡️' onPress={nextHandler} />
      </View>
    </View>
  );
}
